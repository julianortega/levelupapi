...
public class RoutineBeansConfig {
    ...
    @Bean
    CreateRoutineUseCase createRoutineUseCase(RoutineRepository routines, ExerciseRepository exercises, RoutineService routineService) {
        return new CreateRoutineService(routines, exercises, routineService);
    }
    
    @Bean
    GetRoutineUseCase getRoutineUseCase(RoutineRepository routines) { 
        return new GetRoutineService(routines); 
    }
    
    @Bean
    ListRoutinesUseCase listRoutinesUseCase(RoutineRepository routines) { 
        return new ListRoutinesService(routines); 
    }
}
